...
<body>
    ...
    <div class="container-fluid">
        <div class="d-flex mr-2">
            <h2 class="pl-2 pt-4" style="color:#FA8C1E; letter-spacing: 3px; white-space: nowrap;">2020 Fantasy Football Ranking</h2>
            <div class="d-flex float-right pt-4" style="padding-left: 280px;">
                <a href="" class=" mt-4" style="text-decoration: none; white-space: nowrap;">Add Custom Scoring</a>
                <div class="dropdown mt-3 ml-5">
                    <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" style="border: 1px solid gray; border-radius: 0px!important;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Scoring Type
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="#">Link 1</a>
        ...
        <div class="d-flex flex-row align-items-start mt-3" style="padding-left:10px; padding-right: 20px;">
