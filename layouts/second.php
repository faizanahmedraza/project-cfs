    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 pt-4 pl-5">
                ...
                <div class="d-flex justify-content-start ml-0">
                    <button type="button" class="btn btn-light font-weight-bold text-white" style="font-size:20px; color:black; background-color: blue; border-radius:0%!important;">
                        Edit NCAAF Team Name
                    </button>
                    <h2 class="font-weight-bold ml-2" style="color: #FA8C1E;">Roster</h2>
                </div>
            ...
            <div class="col-md-6 pr-5">
                ...
                <div class="pt-0">
                    <div class="input-group d-flex flex-row justify-content-end mb-3">
                        <button class="btn btn-primary btn-lg mt-3 mr-3">Create Team</button>
                        <button class="btn btn-primary btn-lg mt-3 mr-3">Import Team</button>
                        <button class="btn btn-primary btn-lg mt-3 mr-0">Add Team</button>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row mt-4 mb-4">
                <div class="col-md-12 ">
                    <img class="img-fluid" src="../public/images/ground1.jpg" width="100%" alt="">
                </div>
            </div>
        </div>
        <div class="container-fluid">
